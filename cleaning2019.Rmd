...
comp=read.csv("/Users/KevinDing/Desktop/spring-2022/qtm-capstone/latest data/data2019_complete.csv")
needed=comp%>%select(TractID,renterRate)

data19=merge(data,needed,by.x = "TractID",by.y = "TractID")
data19=rename(data19,renter_rate=renterRate)
```
...
## export datasets
```{r}
write_csv(data19,"/Users/KevinDing/Desktop/spring-2022/qtm-capstone/latest data/data2019.csv")
